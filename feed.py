...
with open('feed.yaml', 'r') as file:
    ...
    # Create the RSS element with attributes
    ...
    # Iterate over items and add them to the channel
    for item in yaml_data['item']:
        ...
        # Create the enclosure element with attributes
        xml_tree.SubElement(item_element, 'enclosure', {
            'url': link_prefix + item['file'],
            'type': 'audio/mpeg',
            'length': str(item['length']).replace(',', '')  # Remove commas if present
        })
